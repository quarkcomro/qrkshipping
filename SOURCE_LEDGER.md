...
| Lifecycle purge/reset policy | Approved project decision and PrestaShop 9.1.4 module lifecycle contract | new implementation | Global typed settings, All-stores-only mutation, reset-hook upgrade path, destructive-operation warnings and lifecycle tests. |
